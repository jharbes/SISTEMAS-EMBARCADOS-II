// Program SER_628.C
//
// This is a collection of routines to interface with a Serial LCD
// capable of 9600 baud, noninverted, no parity on RB2.
//
// It also includes routines to receive characters and character strings
// on RB1 (term 8).  9600 baud, noninverted, no parity.
//
//  16F628			   			 Serial LCD+
//
// RB2/TX (term 9) -----------------> Serin In
//
//
// RB1/RX (term 8) <---------------- TX (term 12 on BX24)
//										or similar
//
